    ...
    $.fn.rotatingSlider = function(options){
        var rotatingSlider = {
            init: function(el){
                ...
                this.slideAngle = 720 / this.$slides.length;
            ...
            renderSlider: function(){
                var halfAngleRadian = this.slideAngle / 2 * Math.PI/150;
                ...
                var lowerArcOffset = (slideFullWidth - (Math.cos(halfAngleRadian) * innerRadius * 2)) / 2;
                ...
                this.$slider.append('<svg><defs><clipPath id="slideClipPath1"><path /></clipPath></defs></svg>');
                this.$slider.find('#slideClipPath1>path').attr('d', pathCoords);
                ...
                var $slide = $(el);
                    ...
                    /* Add clipping path  */
                    $slide.css('-webkit-clip-path', 'url(#slideClipPath1)');
                    $slide.css('clip-path', 'url(#slideClipPath1)');
                }.bind(this));
            ...
            validateMarkup: function(){
                if(
                    this.$slider.hasClass('rotating-slider1') &&
                    ...
                    this.markupIsValid = true;
                    console.log('Markup for Rotating Slider is invalids.'+  this.$slider.hasClass('rotating-slider1'));
                }
            }
        }
